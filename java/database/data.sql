...
(111 ,'Ohio State Medical','111 Kenny road','419-801-3824','09:00:00','17:00:00');

INSERT INTO services(service_name, service_details, hourly_rate, doctor_id)
VALUES ( 'help', 'my arm literally fell off', 1.2, 12),
       ( 'Check up', 'Need a COVID shot', 100, 10),
       ( 'Well Visit', 'School physical', 160, 02);

INSERT INTO appointment(appointment_id, service_id, office_id, patient_id, doctor_id, appt_date, is_notified, is_approved)
VALUES (121, 2, 111, 1, 12,'20240922 09:00:00', 'true', 'true'),
(121, 4, 110, 1, 12,'20240922 09:00:00', 'false', 'false'),
(131, 8, 90, 1, 12,'20240922 09:00:00', 'true', 'true');
