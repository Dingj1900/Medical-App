...
VALUES (1, 'user', '$2a$08$UkVvwpULis18S19S5pZFn.YHPZt3oaqHZnDwqbCW9pft6uFtkXKDC','ROLE_USER','Rash', 'Hour', 'RH','Male','614','rh@yahoo.com','2020-01-01','111 street',
       ...
       (12, 'admin', '$2a$08$UkVvwpULis18S19S5pZFn.YHPZt3oaqHZnDwqbCW9pft6uFtkXKDC', 'ROLE_ADMIN', 'Doctor', 'Glover',
	    ...
	    (500, 'sowee', '$2a$08$UkVvwpULis18S19S5pZFn.YHPZt3oaqHZnDwqbCW9pft6uFtkXKDC', 'ROLE_PROVIDER', 'Rashid', 'Sowah',
        	    'R', 'Male', '419222', 'doc@gmail.com', '1990-02-02', '123 sunny st', 'Columbus', 'OH', '45801', '10:00:00','18:00:00',
        	    'false','true','false','true', 'false', 'true', 'false'),

       (501, 'sheena', '$2a$08$UkVvwpULis18S19S5pZFn.YHPZt3oaqHZnDwqbCW9pft6uFtkXKDC', 'ROLE_PATIENT', 'Sheena', 'Ortiz',
               	    'S', 'Female', '419222', 'doc@gmail.com', '1991-02-02', '123 sunny st', 'Columbus', 'OH', '45801', '10:00:00','18:00:00',
               	    'false','true','false','true', 'false', 'true', 'false');
